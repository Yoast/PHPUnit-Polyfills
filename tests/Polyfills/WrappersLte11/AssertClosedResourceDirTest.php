...
use Yoast\PHPUnitPolyfills\Tests\Polyfills\AssertClosedResourceDirTestCase;
...
#[RequiresPhpunit( '< 12' )]
final class AssertClosedResourceDirTest extends AssertClosedResourceDirTestCase {}

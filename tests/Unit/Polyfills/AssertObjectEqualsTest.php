...
use Yoast\PHPUnitPolyfills\Tests\Unit\Polyfills\Fixtures\ValueObjectParamNotRequired;
...
final class AssertObjectEqualsTest extends TestCase {
	...
	public function testAssertObjectEqualsFailsOnMethodParamNotRequired() {
		$msg = 'Comparison method Yoast\PHPUnitPolyfills\Tests\Unit\Polyfills\Fixtures\ValueObjectParamNotRequired::equalsParamNotRequired() does not declare exactly one parameter.';
